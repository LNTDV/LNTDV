...
(function(){
  ...
  function installFinalStyle(){
    ...
    style.textContent=`
      header h1::before,header h1::after,header .lntdv-project-heading::before,header .lntdv-project-heading::after,header .lntdv-title-description::before,header .lntdv-title-description::after,.lntdv-title-description::before,.lntdv-title-description::after,header::before,header::after{content:none!important;display:none!important;background:none!important}
      header{position:relative!important;background:#fbf6ef!important;color:#5a3b2b!important}
      header h1,header h1.lntdv-project-heading,header .lntdv-project-heading{color:#5a3b2b!important}
      header .lntdv-author-heading,header .lntdv-heading-subtitle,header .intro{color:#5a3b2b!important}
      ...
      #infoDrawer.info-drawer{z-index:2147482999!important;pointer-events:none!important}
      #infoDrawer.info-drawer.open{transform:translateX(0)!important;pointer-events:auto!important}
      header #lntdv-home-project-description{display:block!important;width:min(820px,calc(100% - 28px))!important;margin:16px auto 0!important;padding:0!important;box-sizing:border-box!important;text-align:center!important;color:#5a3b2b!important}
      header #lntdv-home-project-description h2{margin:0 0 9px!important;font:700 clamp(24px,6vw,31px)/1.15 Georgia,serif!important;color:#5a3b2b!important}
      header #lntdv-home-project-description p{margin:0!important;font:400 16px/1.55 Georgia,serif!important;color:#5a3b2b!important}
      ...
      #lntdv-final-story-qr .qr-label{font:600 11px/1.3 Arial,sans-serif!important;letter-spacing:.7px!important;color:#5a3b2b!important}
      header .lntdv-title-description{color:#5a3b2b!important}
      @media(max-width:700px){#infoMenuButton.info-menu-button{top:12px!important;right:14px!important;left:auto!important}header #lntdv-home-project-description{width:calc(100% - 28px)!important;margin-top:14px!important}header #lntdv-home-project-description h2{font-size:25px!important;margin-bottom:8px!important}header #lntdv-home-project-description p{font-size:16px!important;line-height:1.5!important}#lntdv-final-story-qr{margin-top:16px!important;margin-bottom:12px!important}#lntdv-final-story-qr img{width:136px!important;height:136px!important;max-width:136px!important}}
    `;
  ...
  function moveQr(){
    ...
    if(description){description.textContent=evocativeShow;qr.insertAdjacentElement("afterend",description)}
  }
  ...
  function wireMenu(){
    ...
    btn.addEventListener("pointerup",function(e){if(e.pointerType!=="mouse") {e.preventDefault();toggle(e)}},false);
  ...
  function init(){
    ...
    const btn=document.getElementById("infoMenuButton");
    if(btn&&header){header.style.position="relative";btn.style.position="absolute";btn.style.top="14px";btn.style.right="16px";btn.style.left="auto";btn.style.bottom="auto";btn.style.pointerEvents="auto"}
    moveQr();
    wireMenu();
